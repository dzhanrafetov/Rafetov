...
const Hero = () => {
  ...
  return (
    <div  id="hero" className="relative bg-gradient-to-b from-black via-gray-900 to-black text-white flex flex-col justify-center items-center px-6 py-36 sm:py-40 overflow-hidden">
