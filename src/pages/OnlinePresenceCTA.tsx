  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white py-16 px-8 sm:px-20">
      ...
      <header className="text-center mb-20">
        <motion.h1
          className="text-5xl sm:text-6xl font-extrabold tracking-wide bg-gradient-to-r from-purple-500 to-teal-500 bg-clip-text text-transparent"
        ...
        >
          A strong digital presence is the foundation of modern business success. Here’s why you can’t afford to miss out.
        </motion.p>
      </header>
