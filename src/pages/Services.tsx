...
import { FiGlobe, FiSmartphone, FiCamera, FiShare2 } from 'react-icons/fi';
...
const Services = () => (
  <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white py-24 px-8 sm:px-20">
    ...
    <header className="text-center mb-16">
      <motion.h1
        className="text-6xl sm:text-7xl md:text-8xl font-extrabold tracking-wide bg-gradient-to-r from-green-400 to-blue-500 bg-clip-text text-transparent"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
